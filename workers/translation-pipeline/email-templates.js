// Email HTML template builders for the translation pipeline worker

export function completionEmailHtml({ workTitle, translationUrl, pdfUrls, sponsorName }) {
  ...
  return `
    <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; color: #333;">
      ...
      <p>${sponsorName ? sponsorName + ', your' : 'Your'} translation of <strong>&ldquo;${workTitle || 'your text'}&rdquo;</strong> is complete.</p>
      <p>Three AI translators deliberated and converged on a final rendering, reviewed for fidelity to the source.</p>
      <p><a href="${translationUrl}" style="color: #b8860b;">View the full translation</a></p>
      ${pdfSection}
...
export function digestEmailHtml({ newTranslations, popular, origin }) {
  ...
  return `
    <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; color: #333;">
      ...
      <p>Hi {{name}}, here&rsquo;s what&rsquo;s new in the world of committee translations.</p>
      ${newSection}
      ${popularSection}
